@echo off
echo -------------------------------------------------------------------------------------------------------------------
echo                       This script install "ComfyUI_windows_portable_nvidia_or_cpu_nightly_pytorch"
...
%curDir%7z\7z x "%curDir%ComfyUI_windows_portable_nvidia_or_cpu_nightly_pytorch.7z"
echo Done 
@RD /S /Q "%curDir%7z"
if exist "ComfyUI_windows_portable_nvidia_or_cpu_nightly_pytorch.7z" del /f /q "ComfyUI_windows_portable_nvidia_or_cpu_nightly_pytorch.7z"
echo -------------------------------------------------------------------------------------------------------------------
pause
